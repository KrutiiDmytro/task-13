    ...
    public function run(): void // NOSONAR
    {
        $posts = [
            [
                ...
                'content' => 'PHP 8.1 принес множество новых возможностей, включая readonly properties, '
                    .'enums и улучшенную производительность.',
                'date' => '2024-01-15',
                'category_name' => 'PHP',
            ...
            [
                ...
                'content' => 'У цій статті ми розглянемо основи JavaScript: змінні, типи даних, функції '
                    .'та об\'єкти. Це чудовий старт для будь-якого веб-розробника.',
                'date' => '2024-02-10',
                'category_name' => 'JavaScript',
            ...
            [
                ...
                'content' => 'Огляд популярних інструментів, які спрощують життя розробника: від редакторів '
                    .'коду, таких як VS Code, до систем контролю версій, як Git.',
                'date' => '2024-04-01',
